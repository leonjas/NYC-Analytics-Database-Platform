...
## 2. Web Application URL (server instance has been stopped)
...
### Demo
1. **Search for an Address**: Enter house number (e.g., "88-08"), street name (e.g., "151ST AVE"), and select borough (e.g., "Queens")
2. **View Analytics**: See service request counts, complaint type breakdown, property sale statistics, and time series visualizations
3. **Bookmark Properties**: Save BBLs for quick access later
